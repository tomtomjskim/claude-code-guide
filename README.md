...
- **릴리즈 노트**: https://github.com/tomtomjskim/claude-code-guide/blob/main/docs/v4.8-changelog.md
```
...
상세 계약: [ECC 선별 도입 및 설치 수명주기](docs/39-ecc-selective-adoption.md)
...
| **39** | **[ECC 선별 도입 및 설치 수명주기](docs/39-ecc-selective-adoption.md)** | **검토된 ref, install-state, doctor/repair/uninstall, 공급망 경계** |
